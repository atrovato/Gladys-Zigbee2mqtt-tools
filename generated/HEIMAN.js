...
const HEIMAN = {
  ...
  models: {
    ...
    'HM1RC-2-E': [features.switch_sensor],
    ...
    HS1DS: [features.door],
    'HS1EB/HS1EB-E': [features.switch_sensor],
    ...
    'HS1RC-EM': [features.switch_sensor],
    'HS1RC-N': [features.switch_sensor],
    ...
    'HS2ESK-E': [features.current, features.power, features.switch, features.voltage],
    // HS2IRC: [],
    HS2SK: [features.current, features.power, features.switch, features.voltage],
    HS2SK_nxp: [features.current, features.power, features.switch, features.voltage],
    HS2SS: [features.switch_sensor],
    'HS2SW1A/HS2SW1A-N': [features.switch],
    'HS2SW2A/HS2SW2A-N': [features.switch],
    'HS2SW3A/HS2SW3A-N': [features.switch],
    // 'HS2WD-E': [],
    ...
    'SKHMP30-I1': [features.current, features.power, features.switch, features.voltage],
