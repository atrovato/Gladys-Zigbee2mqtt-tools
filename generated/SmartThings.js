...
const SmartThings = {
  ...
  models: {
    ...
    'F-APP-UK-V2': [features.current, features.power, features.switch, features.voltage],
    'F-MLT-US-2': [features.door, features.temperature],
    'GP-LBU019BBAWU': [features.brightness, features.light],
    'GP-WOU019BBDWG': [features.energy, features.power, features.switch],
    ...
    'STS-OUT-US-2': [features.current, features.power, features.switch, features.voltage],
    'STS-PRS-251': [features.switch_sensor],
